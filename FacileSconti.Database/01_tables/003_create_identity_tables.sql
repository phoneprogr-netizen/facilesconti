...
-- ============================================
-- ASP.NET Core Identity - Schema base + campi custom ApplicationUser
-- SQL Server
-- ============================================
...
BEGIN
    ...
    (
        ...
        -- campi custom presenti in ApplicationUser
        FirstName NVARCHAR(120) NOT NULL CONSTRAINT DF_AspNetUsers_FirstName DEFAULT(N''),
        LastName NVARCHAR(120) NOT NULL CONSTRAINT DF_AspNetUsers_LastName DEFAULT(N''),
        UserType INT NOT NULL CONSTRAINT DF_AspNetUsers_UserType DEFAULT(0),
...
-- Se la tabella AspNetUsers esiste già (creata con schema standard),
-- aggiunge in modo incrementale le colonne custom mancanti.
IF COL_LENGTH('dbo.AspNetUsers', 'FirstName') IS NULL
BEGIN
    ALTER TABLE dbo.AspNetUsers
    ADD FirstName NVARCHAR(120) NOT NULL CONSTRAINT DF_AspNetUsers_FirstName DEFAULT(N'');
END
GO
...
BEGIN
    ALTER TABLE dbo.AspNetUsers
    ADD LastName NVARCHAR(120) NOT NULL CONSTRAINT DF_AspNetUsers_LastName DEFAULT(N'');
END
GO

IF COL_LENGTH('dbo.AspNetUsers', 'UserType') IS NULL
BEGIN
    ALTER TABLE dbo.AspNetUsers
    ADD UserType INT NOT NULL CONSTRAINT DF_AspNetUsers_UserType DEFAULT(0);
END
GO
...
BEGIN
    ALTER TABLE dbo.AspNetUsers
    ADD CreatedAt DATETIME2 NOT NULL CONSTRAINT DF_AspNetUsers_CreatedAt DEFAULT(SYSUTCDATETIME());
END
GO
